...
//  spellingForMyKids
//
//  Created by Olivier Delecueillerie on 03/06/2014.
...
@interface SPUtterance () <AVSpeechSynthesizerDelegate>
...
- (void) speechUterance:(NSString *)speech {
  
    
    
    if (speech && !self.synthesizer.isSpeaking)
    {
...
- (void)restoreUserPreferences
{
    ...
    NSDictionary *defaults = @{ UYLPrefKeySelectedPitch:[NSNumber numberWithInteger:UYLPitchControlNormalPitch],
                                UYLPrefKeySelectedSpeed:[NSNumber numberWithInteger:UYLSpeedControlQuarterSpeed],
